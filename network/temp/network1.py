...
cam = net.addDocker('cam', ip='10.0.0.21', dimage="kumokay/ubuntu_wifi:v6", ports=[19000], port_bindings={19000: 20000})#docker_ip=172.18.0.2

tx2 = net.addDocker('tx2', ip='10.0.0.102', dimage="kumokay/ubuntu_wifi:v6")#docker_ip=172.18.0.3
act = net.addDocker('act', ip='10.0.0.101', dimage="kumokay/ubuntu_wifi:v6")#docker_ip=172.18.0.4
